...
{
    [Fact]
    public async Task RunPersonalFolderMigration_AsAdmin_CreatesPersonalFolders()
    {
        // Arrange
        ...
        var response = okResult.Value as Backend.Models.DTO.Common.ApiResponse<int>;
        response.Should().NotBeNull();
        response!.Data.Should().BeGreaterThanOrEqualTo(1);
    ...
    [Fact]
    public async Task RunPersonalFolderMigration_AsNonAdmin_ReturnsForbid()
    {
        // Arrange
        var context = DbContextHelper.GetInMemoryDbContext();
